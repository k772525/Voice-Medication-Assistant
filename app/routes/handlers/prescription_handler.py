...
def handle(event):
    ...
    try:
        ...
        elif hasattr(event, 'message') and hasattr(event.message, 'text') and event.message.text is not None:
            # 處理文字訊息
